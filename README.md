...
17. Additionally the output for the processed data can be seen in the output witin the data folder .csv file that with 1 row per processed revision located in.  The data output is in the format "'pageid', 'pagetitle',  'label', 'revisionid', 'timestamp', 'comment', 'parentid'"
