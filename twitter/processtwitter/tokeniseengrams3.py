# This class applies n-grams (3-grams) to the data from the data located in the folder tokenisetweets3 where the output
# is stored in the folder ngrams3. If the sentence length is less than or equal to 3 word add the word to the output 
# file otherwise apply 3-grams to the text and output each sentence to the output file.
                ...
                if (line != []):
                    ...
                    if (words and isMinLengthLine(line[0])):
                        ...
                        if (sentanceLength <= 3):
                            ...
                            print('More than 3 word items')
                            print(myData)
                            print('######')
                            n = 3
                            threeGrams = ngrams(myData.split(' '), n)
