# This class applies n-grams (4-grams) to the data from the data located in the folder tokenisetweets3 where the output
# is stored in the folder ngrams4. execution of tokeniseengrams4.py results in no additional data as the large hashtags
# were already split in the previous step.
                ...
                if (line != []):
                    ...
                    if (words and isMinLengthLine(line[0])):
                        ...
                        if counter >= 5000:
                            ...
                            counter=0
                        if (sentanceLength <= 4):
                            print('Greater than equal to 4 words')
                            writer = csv.writer(filename, delimiter=' ')
                            print(words)
                            writer.writerow(words)
                            counter += 1 
                        else:
                            print('More than 4 words in item')
                            print(myData)
                            print('######')
                            n = 4
                            fourGrams = ngrams(myData.split(' '), n)
