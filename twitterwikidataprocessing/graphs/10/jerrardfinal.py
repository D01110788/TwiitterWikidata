...
with open('./wikidatatwitter1.csv', 'r') as f:
        print('#####    TRY ######')
        read = csv.reader(f) 
        filepath = os.path.join(here, subdir, 'listjacartadistance0' + '.csv')
        ...
        for line in read:
            ...
            #print(lineitem.split()[0])
            #print(lineitem1.split()[0])
            #print(ks_2samp(list(lineitem[0]), list(lineitem1[0]))
