...
# Due to processing processing out of memory exception errors the wikidata list was reduced 
# in size based on the number of occurrences of revisions that were applied. All titles with 
